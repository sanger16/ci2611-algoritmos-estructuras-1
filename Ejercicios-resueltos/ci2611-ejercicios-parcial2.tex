...
\usepackage{fancyhdr}
\pagestyle{fancy}
\rfoot[CI2611 - Problemario]{CI2611 - Problemario}
%\rfoot{\thepage}
\doublespacing
%---
%Customize
...
$\quad \{Inv: r =(max \; p,q| \; 0 \leq p < q < x : A[p] - A[q]) \land 0 \leq x \leq N \land s = (max \; p| \; 0 \leq p < x : A[p])\} \{Cota: N-x\}$\par
...
\subsection{Parcial 1 Ene-Mar 2025}
